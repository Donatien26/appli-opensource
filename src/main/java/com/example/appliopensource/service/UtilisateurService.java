...
public class UtilisateurService {
	...
	public List<Utilisateur> findAll() {
		...
		ResponseEntity<Personnes> response = restTemplate.getForEntity(
				"http://qfigesalht01.ad.insee.intra/securite-applicative/recherche/utilisateur/tous?withGroup=true",
				Personnes.class);
	...
	public Utilisateur whoIam() {
		...
		ResponseEntity<Personnes> response = restTemplate
				.getForEntity("http://qfigesalht01.ad.insee.intra/securite-applicative/recherche/utilisateur/idep/"
